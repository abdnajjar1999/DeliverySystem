import 'package:durub_ali/screens/drivers/driverfatorah.dart';
...
class driverInfoScreen extends StatefulWidget {
  final Users user;
  driverInfoScreen({required this.user});
...
class _UserInfoScreenState extends State<driverInfoScreen> {
  ...
  Future<void> fetchOrderData() async {
    try {
      ...
      QuerySnapshot ordersSnapshot = await FirebaseFirestore.instance
          .collection('orders')
          .where('driverName', isEqualTo: widget.user.userId)
          .get();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Driver Information', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
        actions: [
          Container(
            ...
            child: ElevatedButton.icon(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => DeliveryReceiptfordriver(userOrders: filteredOrders),
                  ),
                );
              },
            ),
                ...
                Container(
                  ...
                  child: CircleAvatar(
                    ...
                    child: widget.user.profileImage.isEmpty
                        ? Icon(Icons.drive_eta_rounded, color: Colors.grey, size: 40)
                        : null,
                  ),
                ),
                SizedBox(width: 20),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildInfoColumn('Role', 'Driver', Icons.drive_eta_outlined, accentColor),
